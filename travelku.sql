...
INSERT INTO `metode_transaksi` (`ID_METODE`, `NAMA_METODE`) VALUES
(1, 'OVO'),
(2, 'Dana'),
(3, 'Gopay'),
(4, 'BNI'),
...
INSERT INTO `mobil` (`ID_MOBIL`, `JENIS_MOBIL`, `NOPOL`, `MERK`, `TAHUN`, `FOTO_MOBIL`, `KAPASITAS_PENUMPANG`) VALUES
(2, 'MPV', 'sjhdgjahs', 'Toyota', 1234, 'kucing2024-06-1673396286.jpeg', 12);
...
INSERT INTO `rute` (`ID_RUTE`, `NAMA_RUTE`, `ASAL`, `TUJUAN`, `HARGA`) VALUES
(1, 'Surabaya-Malang', 'Surabaya ', 'Malang ', 140000),
(2, 'Malang-Surabaya', 'Malang', 'Surabaya', 140000),
(3, 'Surabaya-Jombang', 'Surabaya', 'Jombang', 110000),
(4, 'Jombang-Surabaya', 'Jombang', 'Surabaya', 110000);
...
INSERT INTO `user` (`ID_USER`, `NAMA`, `NO_TELP`, `EMAIL_USER`, `PASSWORD`, `IS_ADMIN`) VALUES
(2, 'Admin Rill', '12345', 'admin@gmail.com', '$2y$10$un3k5ikAkF/g5PKYOXKmjux6WVhEpvKzR9k8RipL635Ze2BCPeI1q', 1);
...
--
ALTER TABLE `metode_transaksi`
  MODIFY `ID_METODE` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
